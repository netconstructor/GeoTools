 ...
 * 
 *         GM_SurfacePatch (Figure 20) defines a homogeneous portion of a GM_Surface. The
...
public abstract class SurfacePatchImpl implements SurfacePatch, Serializable {
     ...
     * 
     * GM_SurfacePatch::Interpolation : GM_SurfaceInterpolation Default is Planar interpolation
     */
     ...
     * 
     * GM_SurfacePatch::numDerivativesOnBoundary[0..1] : Integer Default is 0 (simple continuity)
     */
     ...
     * schema.
     * 
     * GM_Surface::patch [1..n] : GM_SurfacePatch GM_SurfacePatch::surface [0,1] :
     * Reference<GM_Surface>
     * 
     * If the GM_Surface.coordinateDimension is 2, then the entire GM_Surface is one logical patch
     * defined by linear interpolation from the boundary.
     * 
     * NOTE In this standard, surface patches do not appear except in the context of a surface, and
     * therefore the cardinality of the surface role in this association could be 1 which would
     * preclude the use of surface patches except in this manner. While this would not affect this
     * Standard, leaving the cardinality as 0..1 allows other standards based on this one to use
     * surface patches in a more open-ended manner.
     */
