...
public class VersionDetail {
    ...
    private static String DATE_PREFIX = "date:";
    private static String RANGE_PREFIX = "start:";
    private static String RANGE_SEPARATOR = " end:";
...
//            dow mon dd hh:mm:ss zzz yyyy
    ...
    public Integer getIndex() {
        if(this.type.equals(VersionType.Index))
            return this.index;
        return null;
    }
