...
public class VersionedJDBCUpdateFeatureWriter extends JDBCUpdateFeatureWriter
		implements VersioningFeatureWriter<SimpleFeatureType, SimpleFeature> {

	public VersionedJDBCUpdateFeatureWriter(PreparedStatement ps,
			Connection cx,
	 ...
	 * @throws IOException
	 */
	public VersionedJDBCUpdateFeatureWriter(String sql, Connection cx,
			VersionedJDBCFeatureSource<SimpleFeatureType, SimpleFeature> featureSource,
			Hints hints) throws SQLException, IOException {
	...
	/* (non-Javadoc)
	 * @see org.geotools.jdbc.JDBCUpdateFeatureWriter#remove()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.geotools.jdbc.JDBCUpdateFeatureWriter#write()
	 */
	@Override
